...
[Defines]
  ...
  OUTPUT_DIRECTORY               = Build/Fake-$(ARCH)
...
[LibraryClasses.common]
  ...
  ArmVirtMemInfoLib|FakePkg/library/memory_lib/memory_lib.inf
  ...
  PlatformBootManagerLib|FakePkg/library/platform_boot_manager_lib/platform_boot_manager_lib.inf
...
[Components.common]
  ...
  # PEI Phase modules
  #
  FakePkg/PrePi/ArmVirtPrePiUniCoreRelocatable.inf {
    <LibraryClasses>
...
!endif
  ...
  # ACPI Support
  #
  FakePkg/PlatformHasAcpiDtDxe/PlatformHasAcpiDtDxe.inf
[Components.AARCH64]
